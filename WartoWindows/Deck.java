...
public class Deck // extends genericpile something or other
{
   /** 
...
// add at arraylist.size to add to end of arrylist
// make a generic card pile, be able to add, delete, find size/ empty